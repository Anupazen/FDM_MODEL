...
def predict():
    ...
    Avg_credit_limit_used = float(request.form["Avg_credit_limit_used"])/100
    Avg_credit_limit_used = ceil((Avg_credit_limit_used/0.2)+1)
    ...
    inputs=[IsFirst,Previous_loan_paid,Current_other_loans,Is_employeed,Dependents,Credit_card_limit,Avg_credit_limit_used,Yearly_salary,Age,Saving_amount,Checking_amount]
    if(Purpose==1):
